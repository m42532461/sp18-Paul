...
public class Board implements WorldState{
    ...
    */
    ...
    /*
    hamming(): The number of tiles in the wrong position
     */
    public int hamming(){
        int sum = 0;
        for (int i = 0; i < row; i++) {
    ...
    /*
    manhattan(): The sum of the Manhattan distances (sum of the vertical and horizontal distance) from the tiles to their goal positions
     */
